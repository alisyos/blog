...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <header className="py-8 bg-white dark:bg-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          <Link 
            href="/admin" 
            className="absolute top-0 right-0 text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 px-3 py-2 rounded-md border border-blue-300 hover:border-blue-500 transition-colors"
          >
            관리자 페이지
          </Link>
        </div>
